...
import com.example.springdemo.domain.service.ProductService;
...
public class ProductController {
    ...
    @Autowired
    private ProductService productService; //we need the service
    ...
    @GetMapping("/{id}")
    @ApiOperation("Search a product by id") //description
    @ApiResponses({
